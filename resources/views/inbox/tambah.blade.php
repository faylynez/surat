...
@section('judul', 'Form Tambah Data Surat Masuk')
@section('konten')
<div class="product-card shadow">
    <form action="/inbox" method="POST">
        ...
        <div class="mb-3">
            ...
            <input value="{{old('tanggal_terima')}}" name="tanggal_terima" type="date" class="form-control @error('tanggal_terima') is-invalid @enderror">
        ...
        <div class="mb-3">
            <a href="/inbox" class="btn btn-secondary">Kembali</a>
