...
<div class="product-card shadow">
    <a class="btn btn-primary mb-3 mt-3" href="/dispo/create">
    ...
    <form action="" method="get">
        <div class="input-group mb-3">
            ...
            <a href="/dispo" class="btn btn-danger">Clear</a>
          </div>          
    </form>
    <table class="table">
        <thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn badge bg-success" href="/dispo/{{$x->id}}">
                    ...
                    <a class="btn badge bg-warning" href="/dispo/{{$x->id}}/edit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        Ubah</a>
                    <form onclick="return confirm('Yakin Data Ini Mau Dihapus??')" action="/dispo/{{$x->id}}"  method="POST"
                        class="d-inline">
                        @csrf
                        @method('delete')
